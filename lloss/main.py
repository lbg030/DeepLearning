...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS):
        ...
        data_train, data_unlabeled, data_test, adden, NO_CLASSES, NUM_TRAIN = load_dataset(args.dataset)
        ...
        for cycle in range(CYCLES):
            ...
            # TODO: 만약에 AOI데이터셋 사용 시 모델 class 변경 및 load dataset 코드 수정 필요
            
            # Model - create new instance for every cycle so that it resets
            models    =  resnet50(num_classes = 4, pretrained = False).to(device)
            ...
            models = {'backbone': models, 'module': loss_module}
            ...
            train(models, extractor, criterion, optimizers, schedulers, dataloaders, args.no_of_epochs, EPOCHL)
            ...
            arg = query_samples(models,extractor, data_unlabeled, subset)
